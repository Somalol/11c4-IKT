...
books = Tk() 
label = Label(books, text="Könyvek", font=("Arial",30)).grid(row=0, columnspan=4)
...
showScores = Button(books, text="Show books", width=15, command=show).grid(row=4, column=0)
closeButton = Button(books, text="Close", width=15, command=exit).grid(row=4, column=1)
